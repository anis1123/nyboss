(function(d, $, w){
    ...
    Configuration
    ***********************************/
    var launchDate = 'March 18, 2013' ; // Your Launch Date!
    var twitterScreenName = 'npolanco10'; // Your Twitter Screen name
    ...
    ***********************************/
    function showAlert(response){
        if( response.type && response.message ){
            formAlert.html(response.message).addClass('alert-'+response.type).removeClass('hidden');
        }else{
            formAlert.html(response).removeClass('hidden');
        }
    }
